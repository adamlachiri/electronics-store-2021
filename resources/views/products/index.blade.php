    ...
    <div class="row flex-nowrap">
        ...
        <section class="col">
            ...
            <div class="row align-items-stretch">
                ...
                <!-- product -->
                <div class="col-md-6 col-lg-4 p-3 border border-gray position-relative">

                    <!-- promotion -->
                    @if($product->promotion)
                    <div class="position-absolute z-1 bg-success text-white top-0 right-0 font-weight-bold py-1 px-3">
                        -
        ...
        <section class="col-1 border-left border-gray d-sm-block">
            <div class="sticky-top">
                <!-- title -->
                <div class="pt-2 text-center">
                    <a href="cart" class="text-main hover-text-underline" title="your cart">
